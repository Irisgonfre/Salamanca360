        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img src='{{ asset("Imagenes/$ocio->imagen_ruta") }}' class="card-img-top" alt="Máquina donde salen las bolas de los bolos, el fondo es una bolera.">
                </div>
                </div>
                <div class="col-md-6">
                    <div class="contenedor-tarjeta">
                        <div class="tarjeta">
                            <h2 class="tarjeta-titulo">{{$ocio->nombre}}</h2>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><strong>Descripción:</strong> {{$ocio->decripcionMax}}</li>
                                <li class="list-group-item"><strong>Ubicación:</strong> {{ $ocio->ubicacion }}</li>
                                <li class="list-group-item"><strong>Enlace:</strong> {{$ocio->enlace}}</li>
                                <li class="list-group-item"><strong>Contacto:</strong> {{ $ocio->telefono }}</li>
                                <li class="list-group-item"><strong>Precio:</strong> {{$ocio->precio}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
