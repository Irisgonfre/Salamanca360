    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="imagenes/gastronomia1.jpg" class="d-block w-100" alt="actividades">
          </div>
        </div>
    </div>
                ...
                @foreach($gastronomia as $gast)
                    <div class="col-md-4">
                        <div class="tarjeta-actividad">
                            <form action='{{url("gastronomia/$gast->id")}}' method="get">
                            ...
                            <div class="botones-actividad">
                                <form action='{{url("destroyGastronomia/$gast->id")}}' method="POST">
                                    @csrf
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button class="btn btn-custom-eliminar btn-sm" type="submit">Eliminar</button>
                                </form>
                                <a class="btn btn-custom-editar btn-sm" href='{{url("editGastronomia/$gast->id")}}'>Editar</a>
                            </div>
                        </div>
                    </div>
                @endforeach
