                ...
                @foreach($actividades as $actividad)
                    <div class="col-md-4">
                        <div class="tarjeta-actividad">
                            <form action='{{url("actividades/$actividad->id")}}' method="get">
                            ...
                            <div class="botones-actividad">
                                <form action='{{url("destroyActividad/$actividad->id")}}' method="POST">
                                    @csrf
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button class="btn btn-custom-eliminar btn-sm" type="submit">Eliminar</button>
                                </form>
                                <a class="btn btn-custom-editar btn-sm" href='{{url("editActividad/$actividad->id")}}'>Editar</a>
                            </div>
                        </div>
                    </div>
                @endforeach
