...
<div class="container">
    <div class="tarjeta fondo-tarjeta">
        ...
        <h2><strong>Ingresa los datos de los lugares de interés:<strong></h2>
        
        <form action='{{url("guardarLugaresInteres")}}' enctype="multipart/form-data" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                <textarea id="ubicacion_enlace" name="ubicacion_enlace" rows="4" cols="50" class="form-control" placeholder="Ubicación enlace" required></textarea>
            </div>
            <div class="mb-3">
                <input type="text" id="enlace" name="enlace" class="form-control" placeholder="Enlace" required>
            </div>
            <div class="mb-3">
                <textarea id="descripcionMin" name="descripcionMin" rows="4" cols="50"  class="form-control" placeholder="Descripción Mínima" required></textarea>
            </div>
            <div class="mb-4">
                <textarea id="descripcionMax" name="descripcionMax" rows="4" cols="50"  class="form-control" maxlength="2000" placeholder="Descripción Máxima" required></textarea>
            </div>
